...
public class AdapterMovimentacao extends RecyclerView.Adapter<AdapterMovimentacao.MyViewHolder>{
    ...
    @Override
    public AdapterMovimentacao.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemLista = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_movimentacao, parent, false);
        return new AdapterMovimentacao.MyViewHolder(itemLista);
    }


    @Override
    public void onBindViewHolder(AdapterMovimentacao.MyViewHolder holder, int position) {
